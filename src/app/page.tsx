    ...
    <div className='w-full flex justify-center align-center'>
      <main className="flex min-h-screen flex-col justify-between p-24 w-[100%]">
        <div className='w-full flex justify-center align-center flex-col'>
          ...
          <p className='mt-0.5'>By Upsided, Information from <a href="https://libs.advaith.io/" className='text-blue-500 hover:underline underline-offset-4 decoration-1 duration-100'>libs by Advaith</a></p>
