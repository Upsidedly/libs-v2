...
export default function Home() {
  return (
    <div className='w-full flex justify-center align-center'>
      <main className="flex min-h-screen flex-col items-center justify-between p-24 w-[95%]">
        <div>
          <h1 className='scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl'>Discord API Library Comparisons</h1>
          <p className='mt-0.5'>By Upsided, Forked from <a href="https://libs.advaith.io/" className='text-blue-500 hover:underline underline-offset-4 decoration-1 duration-200'>libs by Advaith</a></p>
        </div>
